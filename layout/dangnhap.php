...
<?php include "head.php" ?>
    ...
    <div class="header-bottom">
        <ul class="menu-header-bottom">
            ...
            <li style="color:#999 ;"> Đăng nhập </li>

        </ul>

    </div>
    <div style="background-color: #f8f8f8; height: 20px;"></div>
    <h2 class="sec-content-heading text-center">ĐĂNG NHẬP</h2>
    <p class="sec-slogan text-center"><a href="./dangky.php">Nếu bạn không có tài khoản ấn vào đây</a></p>
    <div class="row contact-form">
        ...
        <div class="col half-col contact-form-personal" style="background-color: #f8f8f8; text-align: center;">
            <form action="../Back-enddevelopment/dangnhap.php" method="post">
                <div class="row">
                ...
                <div class="row">
                    <div class="col full-col contact-input mt-8" style="margin-top: 10px;">
                        <input type="password" placeholder="Mật khẩu" name="pass" id="" class="form-cotrol text-center">
                    </div>
                </div>
                <input class="button pull-right-dangnhap " style=" background-color: #000;" type="submit" value="ĐĂNG NHẬP">
            </form>
